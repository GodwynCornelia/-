...
{
    public class SecondJsonRepository : ISecondRepository
    {
        ...
        public IEnumerable<Delish> GetAllSecond()
        {
            return delishs;
        }
        public Delish GetSecond(int id)
        {
            return delishs[id];
        }
        ...
        public void AddSecond(Delish delish)
        {
            delishs.Add(delish);
            SaveDelishList(delishs);
        }
        public void SaveSecond(int id, Delish delish)
        {
            delishs[id] = delish;
            SaveDelishList(delishs);
        }
