...
{
    public class DrinkJsonRepository : IDrinkRepository
    {
        ...
        public IEnumerable<Delish> GetAllDrink()
        {
            return delishs;
        }
        public Delish GetDrink(int id)
        {
            return delishs[id];
        }
        ...
        public void AddDrink(Delish delish)
        {
            delishs.Add(delish);
            SaveDelishList(delishs);
        }
        public void SaveDrink(int id, Delish delish)
        {
            delishs[id] = delish;
            SaveDelishList(delishs);
        }
