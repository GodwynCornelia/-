...
{
    public partial class deserts : Form, IdesertsView
    {
        ...
        public IList<string> DesertList
        {
        ...
        public Presenter.delish.DesertPresent Presenter { get; set; }


        private void deserts_Load(object sender, EventArgs e)
        {
