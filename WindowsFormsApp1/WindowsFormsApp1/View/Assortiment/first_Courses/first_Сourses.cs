...
{
    public partial class first_Сourses : Form, IfirstView
    {
        ...
        public Presenter.delish.FirstPresent Presenter { get; set; }
        ...
        private void first_Сourses_Load(object sender, EventArgs e)
        {
