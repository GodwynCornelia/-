...
{
    public partial class second_Courses : Form, IsecondView
    {

        public event EventHandler LoadAssortimentForm;
        public second_Courses()
        {
            InitializeComponent();
        }
        public IList<string> SecondList
        {
        ...
        public Presenter.delish.SecondPresent Presenter { get; set; }
        private void button1_Click_1(object sender, EventArgs e)
        {
            
        }

        private void second_Courses_Load(object sender, EventArgs e)
        {
